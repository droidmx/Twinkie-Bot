...
module.exports.run = async (bot, message, args) => {
    let InsultTarget = message.mentions.users.first()
  let replies = ['Is your ass jealous of the amount of shit that just came out of your mouth?',
  ...
  let insultembed = new Discord.RichEmbed()
    ...
    .setColor(green)
    .addField(':anger: Insult :anger:', replies[result]);
