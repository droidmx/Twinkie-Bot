...
.addField("Report", "Report a mentioned user **Make sure you have a Staff role in your server!**")
.addField("Rdefine", "Randomly send a definition.")
.addField("Roll", "Roll a number between 1-100.")
.addField("invite", "Generate a server invite.")
...
.addField("Tempmute", "Mute a mentioned user temporary for a provided period of time.(s/m/h/d) **Make sure you have a Staff role in your server!**")
.addField("Test", "Simple test command that I can't explain.")
.addField("Userstats", "Provide user with their statistics.")
.addField("Warn", "Warn a mentioned user **Make sure you have a Staff role in your server!**")
...
.setTimestamp()
.setColor(green);
message.channel.send(":white_check_mark: | **I have sent you all my commands! Make sure to check your Direct messages!**");
message.author.send(cembed).then(message => message.react(":tickYes:315009125694177281"));
